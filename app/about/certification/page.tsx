...
export default function CertificationPage() {
  ...
  return (
    <>
      <PageTitleBand
        title="Certification"
        breadcrumbs={[{ label: 'About Us' }, { label: 'Certification' }]}
        description="Letters of recommendation and appreciation from our clients — plus quality and industry accreditations."
      />
      ...
      <section className="section-pad bg-surface border-t border-hairline">
        <div className="container-max">
          <SectionHeading title="Accreditations & Certifications" />
