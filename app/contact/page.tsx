...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with BD Buildcon LLP — call, email or send us a project enquiry. Office in Bharuch, Gujarat.',
}
            ...
            <div className="space-y-8">
              <FadeRiseItem>
                ...
                <p className="font-body text-body-lg text-body">
                  We are here to assist you with your industrial EPC needs. Our team responds to all
              ...
              <FadeRiseItem delay={0.1}>
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-body text-label-md text-ink uppercase tracking-wider mb-1">General Enquiries</div>
