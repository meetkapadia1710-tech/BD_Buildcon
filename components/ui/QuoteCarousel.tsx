...
export function QuoteCarousel({ quotes }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-[40px] lg:gap-[72px] items-start">
      <div>
        ...
        <p className="text-[15.5px] leading-[1.7] text-body mb-[28px] lg:mb-[32px]">
        ...
        <div className="flex gap-[10px]">
          <button
            ...
            className="w-[48px] h-[48px] flex items-center justify-center rounded-full bg-white border border-border hover:bg-teal hover:border-teal transition-colors duration-200 group"
          >
            <svg
              width="18"
              height="18"
      ...
      <div className="relative bg-white border border-hairline rounded-card p-[32px] sm:p-[56px] sm:pl-[60px] shadow-[0_4px_16px_rgba(0,0,0,0.04)] min-h-[280px] sm:min-h-[340px] flex flex-col justify-between gap-[28px] sm:gap-[32px]">
        <svg
          width="44"
          height="32"
          viewBox="0 0 28 20"
          fill="#16A8B8"
          className="opacity-[0.25] shrink-0"
          aria-hidden="true"
        >
        ...
        <blockquote
          className={`font-display font-semibold leading-[1.45] tracking-[-0.01em] text-ink m-0 ${
            bigQuote ? 'text-[20px] sm:text-[26px]' : 'text-[17px] sm:text-[22px]'
          }`}
        >
          {current.quote}
        </blockquote>
        <div className="flex items-center justify-between gap-[24px] border-t border-hairline pt-[24px]">
          <div>
